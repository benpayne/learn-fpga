...
- **SC-006**: With no competing traffic, the accelerator sustains at least 90% of the theoretical memory rate.
...
- **SC-013**: The design fits with at least 25% of logic capacity unused and meets its timing target.
